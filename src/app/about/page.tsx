            ...
            <div className="container py-16 md:py-24">
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-lg text-muted-foreground">
                        BonwiriKentey was born from a passion for preserving and sharing the rich cultural tapestry of Ghana. We are more than just a brand; we are storytellers, artisans, and custodians of a vibrant heritage.
                    </p>
                </div>
            </div>
            ...
            <div className="container pb-16 md:pb-24">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 text-muted-foreground">
                        ...
                        <p>When you choose BonwiriKentey, you're not just buying a product. You are acquiring a piece of history, supporting a community of artisans, and weaving a vibrant piece of Ghanaian heritage into the fabric of your own life.</p>
                    </div>
                </div>
            </div>
        </div>
